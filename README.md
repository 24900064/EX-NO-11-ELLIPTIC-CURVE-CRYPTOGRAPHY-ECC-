...
int main() {
    ...
    scanf("%lld", &privateA);
    printf("Enter Somu's private key: ");
    scanf("%lld", &privateB);
    publicA = scalarMultiplication(G, privateA, a, p); 
    publicB = scalarMultiplication(G, privateB, a, p); 
    printf("Ramu's public key: (%lld, %lld)\n", publicA.x, publicA.y);
    printf("Somu's public key: (%lld, %lld)\n", publicB.x, publicB.y);
...
## Output:
<img width="1611" height="877" alt="image" src="https://github.com/user-attachments/assets/8b1a217a-43f2-4007-82da-fa64f4012406" />
